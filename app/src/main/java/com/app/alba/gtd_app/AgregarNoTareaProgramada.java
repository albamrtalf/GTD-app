 ...
 * Create by Alba
 */
public class AgregarNoTareaProgramada extends AppCompatActivity{
...
//                .setIcon(android.R.drawable.ic_menu_close_clear_cancel);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case SALIR:
                ...
                Intent intent = new Intent(AgregarNoTareaProgramada.this,MainActivity.class);
    ...
    public void actividad (String title, String content) {
        Intent intent = new Intent(AgregarNoTareaProgramada.this,VerTarea.class);
